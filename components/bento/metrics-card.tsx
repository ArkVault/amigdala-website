  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="4" label="Memory Types" delay={500} />
        <ScrambleNumber target="12" label="Decision Signals" delay={800} />
        <ScrambleNumber target="87%" label="Context Coverage" delay={1100} />
        <ScrambleNumber target="24" label="Audit Trails" delay={1400} />
      </div>
    </div>
  )
}
